 ...
 *
 * @param {number | object} inputIndex or option
 * @param {Script|(tx, output) => Promise<Script>} unlockScriptOrCallback  unlockScript or a callback returns unlockScript
...
Transaction.prototype.setInputScriptAsync = async function (options, unlockScriptOrCallback) {
  ...
  if (unlockScriptOrCallback instanceof Function) {
    ...
    var unlockScript = await Promise.resolve(unlockScriptOrCallback(this, outputInPrevTx))
